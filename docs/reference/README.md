...
- [Datos y eventos](../architecture/data-and-events.md)

Estas metodologias deben conservar version, razones explicables y limites. Un cambio de pesos, proveedor o estructura de informe requiere pruebas y changelog.
