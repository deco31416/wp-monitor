...
| BO-CALL-28 | El observer se instala dormido antes de habilitar el backend, se arma por alcance firmado y generacion, impide contaminacion entre llamadas, expira por TTL y degrada al motor libpcap si falla; arranque y salud periodica reconcilian contacto y `callId` con la captura autoritativa, recuperan solo coincidencias exactas y desarman alcances huerfanos o divergentes. |
