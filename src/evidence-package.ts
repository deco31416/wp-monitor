...
const REPORT_ROUTE_LIMITATION_LABELS: Record<string, string> = {
    ...
    browser_peer_connection_not_observed: 'No se registraron conexiones WebRTC durante la cobertura disponible.',
    browser_context_replaced: 'La página cambió durante la observación; se conservaron los checkpoints disponibles. Puede faltar evidencia entre muestras.',
    browser_observation_interrupted: 'La observación WebRTC se interrumpió; la cobertura disponible es parcial.',
    browser_cdp_disconnected: 'Se perdió la conexión con el navegador durante la observación.',
    browser_final_checkpoint_unavailable: 'No se pudo recoger la muestra final; se conservaron los checkpoints anteriores disponibles.',
    browser_checkpoint_limit_reached: 'Se alcanzó el límite de evidencia WebRTC acumulada; la muestra está truncada.',
    browser_probe_disarm_unverified: 'No se pudo confirmar el desarme de la sonda; requiere comprobación operacional.',
