...
function syntheticEvidencePackage(): any {
    ...
    return {
        manifest: {
            ...
            contents: [],
            limitations: [
                'Synthetic QA fixture; it contains no customer or production data.',
        ...
        sections: {
            case: {
                caseId,
                title: 'Synthetic report QA fixture',
                status: 'authorized',
                primaryOperator: 'qa-operator',
                authorizationNote: 'Authorized synthetic quality-assurance fixture',
                description: 'Non-production data used to verify report renderers and ZIP packaging.',
                tags: ['qa', 'synthetic'],
            },
            audit: [{
                caseId,
            ...
            callAnalysis: [{
                ...
                candidateIps: [{
                    ...
                    confidence: 'medium',
                    confidenceScore: 55,
                    reasonCodes: [{ code: 'SYNTHETIC', label: 'Synthetic QA observation', delta: 1 }],
                    technicalNote: 'Synthetic documentation IP; it does not identify a real host or person.',
                    isP2P: true,
                }],
                metaIps: ['192.0.2.50'],
                verdict: 'mixed',
